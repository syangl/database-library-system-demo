...
public class ManagerMessage extends JFrame {
	//µ•¿˝ƒ£ Ω
	 ...
	 */
	public void create() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ManagerMessage.class.getResource("/library/book.jpg")));
		...
		textField.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 35));
		...
		JLabel lblNewLabel = new JLabel("π‹¿Ì‘±ID");
		...
		JLabel lblNewLabel_1 = new JLabel("π‹¿Ì‘±√˚");
		lblNewLabel_1.setEnabled(false);
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.BOLD, 30));
		panel.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("π‹¿Ì‘±√‹¬Î");
		lblNewLabel_2.setEnabled(false);
		lblNewLabel_2.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_2.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.BOLD, 30));
		...
		lblNewLabel_3.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.BOLD, 20));
		lblNewLabel_3.setHorizontalAlignment(SwingConstants.CENTER);
		
		textField_1 = new JTextField();
		textField_1.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 20));
		textField_1.setColumns(10);
		
		JButton btnNewButton = new JButton("\u67E5\u8BE2");
		btnNewButton.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.BOLD, 20));
